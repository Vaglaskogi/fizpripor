    ...
    <div class="main-container">
        ...
        <div class="main-info">
            <h1 class="main-info__title">
                ...
                разработчик и производитель комплексных систем автоматизации производствен&shyных процессов
            </h1>
    ...
    <div class="container">
                ...
                <div class="about-block">
                    <div class="about-block__left">
                        <p class="about-left__text">
                            В атомной энергетике компания успешно конкурирует с такими именитыми зарубежными игроками как
                            AREVA, Siemens по параметрам качества, надежности и ценообразования.
                        </p>
                    </div>
        ...
        <div class="about-advantages" data-aos="flip-up" data-aos-duration="500" data-aos-once='true'>
            ...
            <div class="about-advantage">
                ...
                <p class="about-advantage__text">Год основания компании</p>
            </div>
            <div class="about-advantage">
        ...
        <div class="advatages-block">
            <div class="advantage">
                ...
                <p class="advantage-text">
                    Разработка, изготовление и проведение испытаний комплексов технических средств
                </p>
            </div>
            <div class="advantage">
                <div class="advantage-num">02</div>
                <p class="advantage-text">Современная производственная база</p>
            </div>
            <div class="advantage">
                <div class="advantage-num">03</div>
                <p class="advantage-text">Квалифицированные кадры</p>
            </div>
            <div class="advantage">
            ...
            <div class="advantage">
                ...
                <p class="advantage-text">Программируемое и непрограммируемое оборудование</p>
            </div>
        </div>
    </div>
</section>
