<?php include ('header.php'); ?>
      <section class="ktsnpl" data-aos="fade" data-aos-duration="1500" data-aos-once='true'>
         <div class="container">
            <h2 class="ktsnpl-title">КТС НПЛ</h2>
            <h3 class="ktsnpl-subtitle">Комплекс технических средств <span class="accent600">непрограммируемой логики</span></h3>
            ...
            <div class="ktsnpl-block">
               <div class="ktsnpl-text ktsnpl-text-nb">
                  ...
                  <ul class="ktsnpl-block__list">
                     ...
                     <li class="ktsnpl-block__item">«<span class="accentBlack">Жёсткая</span>» логика принципиально неуязвима для киберугроз.</li>
                  </ul>
                  <p class="ktsnpl-block__text">
                     <br />
